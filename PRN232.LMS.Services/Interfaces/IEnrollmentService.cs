...
namespace PRN232.LMS.Services.Interfaces
{
    ...
    {
        Task<PagedResponseModel<EnrollmentResponseModel>> GetEnrollmentsAsync(int? studentId, string? search, string? sort, int page, int size, string? fields, string? expand);
